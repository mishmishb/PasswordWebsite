''' Takes all of the found_words found in word_extraction.py and
creates a consecutive sequence of dictionary and bruteforce
sequences, sorted by appearance in the password. '''
